      ...
      children: [
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: Row(
              children: [
                _statItem(Icons.assignment_outlined, '12', 'Tasks',
                    const Color(0xFF3B82F6)),
                _verticalDivider(),
                _statItem(Icons.check_circle_outline, '8', 'Done',
                    const Color(0xFF22C55E)),
                _verticalDivider(),
                _statItem(Icons.notifications_active_outlined, '3',
                    'Alerts', const Color(0xFFF59E0B)),
                _verticalDivider(),
                _statItem(Icons.star_outline, '4.9', 'Rating',
