            ...
            child: Column(
              ...
              children: [
                _buildSection(
                  ...
                  'By accessing and using MeshWork, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any of these terms, you are prohibited from using or accessing this application. The materials contained in MeshWork are protected by applicable copyright and trademark law.',
                ),
                const Divider(height: 32),
                _buildSection(
                  '2. Use of Services',
                  'MeshWork grants you a limited, non-exclusive, non-transferable license to use the application for your internal business purposes. You agree not to reproduce, duplicate, copy, sell, resell, or exploit any portion of the service without express written permission from e-bi Technology Co. You shall not use the service for any unlawful purpose or in violation of any applicable regulations.',
                ),
                const Divider(height: 32),
                _buildSection(
                  '3. User Accounts',
                  'You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account. You agree to notify us immediately of any unauthorized use of your account. MeshWork reserves the right to suspend or terminate accounts that violate these terms or engage in suspicious activity.',
                ),
                const Divider(height: 32),
                _buildSection(
                  '4. Intellectual Property',
                  'All content, features, and functionality of MeshWork, including but not limited to text, graphics, logos, icons, images, and software, are the exclusive property of e-bi Technology Co. and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.',
                ),
                const Divider(height: 32),
                _buildSection(
                  '5. Data Collection',
                  'By using MeshWork, you consent to the collection and use of information as described in our Privacy Policy. We collect data necessary for providing our services, including but not limited to usage analytics, device information, and user-generated content within the platform.',
                ),
                const Divider(height: 32),
                _buildSection(
                  '6. Limitation of Liability',
                  'In no event shall e-bi Technology Co., its directors, employees, partners, agents, suppliers, or affiliates be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses resulting from your use of MeshWork.',
                ),
                const Divider(height: 32),
                _buildSection(
                  '7. Termination',
                  'We may terminate or suspend your access to MeshWork immediately, without prior notice or liability, for any reason, including breach of these Terms. Upon termination, your right to use the service will immediately cease. All provisions of these Terms which by their nature should survive termination shall survive.',
                ),
                const Divider(height: 32),
                _buildSection(
                  '8. Governing Law',
