            ...
            child: Column(
              ...
              children: [
                _buildSection(
                  ...
                  'MeshWork collects information you provide directly, including your name, email address, phone number, company affiliation, and profile details. We also automatically collect device information, usage data, log files, and analytics to improve our services and provide a better user experience.',
                ),
                const Divider(height: 32),
                _buildSection(
                  '2. How We Use Your Information',
                  'We use collected information to provide and maintain MeshWork services, personalize your experience, communicate with you about updates and changes, analyze usage patterns to improve functionality, ensure platform security, and comply with legal obligations. We do not sell your personal information to third parties.',
                ),
                const Divider(height: 32),
                _buildSection(
                ...
                _buildSection(
                  ...
                  'MeshWork is not intended for use by individuals under the age of 16. We do not knowingly collect personal information from children. If we become aware that we have collected data from a child without parental consent, we will take steps to delete that information promptly.',
                ),
                const Divider(height: 32),
                _buildSection(
                  '8. Changes to This Policy',
                  'We may update this Privacy Policy from time to time to reflect changes in our practices or applicable laws. We will notify you of any material changes by posting the updated policy within the application and updating the "Last updated" date. Your continued use of MeshWork after changes constitutes acceptance of the revised policy.',
                ),
                const Divider(height: 32),
                _buildSection(
                  '9. Contact Us',
